...
import { CheckCircle, ArrowRight, Phone, Wrench } from 'lucide-react';
...
//       'High-bay lighting provisions',
//       'HVAC & ventilation rough-in',
//       'Fire safety & sprinkler provisions',
//     ],
//     popular: true,
//   },
//   {
...
const packages = [
  {
    name: 'Classic Industrial Package',
    price: '₹1,490/sft',
    features: [
      'RCC / PEB industrial structure',
      'Standard industrial flooring',
      'Roofing sheet installation',
      'Basic electrical & plumbing provisions',
      'Compound wall & drainage',
      'Basic office/admin area',
    ],
    popular: false,
  },
  {
    name: 'Premium Industrial Package',
    price: '₹1,890/sft',
    features: [
      ...
      'Premium office/admin finishing',
    ],
    popular: false,
  },
  {
    name: 'Industrial Plus Package',
    price: '₹2,390/sft',
    features: [
      'Everything in Premium',
      'Crane beam provision',
      'High-load industrial flooring',
      'Fire & safety system provisions',
      'Advanced drainage systems',
      'Enhanced elevation & façade design',
    ],
    popular: true,
  },
  {
    name: 'Industrial Signature Package',
    price: '₹3,290/sft',
    features: [
      'Fully customized industrial infrastructure',
      'Large-span structural design',
      'Smart industrial system provisions',
      'Premium corporate office interiors',
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                <Wrench size={12} style={{ color: '#C0392B' }} />
              ...
              >
                ...
                <span style={{ color: '#C0392B' }}>Industrial Scale</span>
              </motion.h1>
              ...
              >
                From warehouses to factories, processing plants to logistics hubs — we deliver industrial construction that meets global standards with local expertise. End-to-end execution including heavy-duty structural work and government approvals.
              </motion.p>
            ...
            >
              <Image
                src="/services/Industrial%20Construction.jpg"
