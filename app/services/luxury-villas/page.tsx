...
// const packages = [
//   {
//     name: 'Signature Villa Package',
//     price: '₹2,490/sft',
//     features: [
//       'Premium RCC structure',
//       'Imported tiles & marble flooring',
//       'Modular kitchen — premium grade',
...
//       'Heritage-style architectural design',
//       'Italian marble throughout',
//       'Premium wood work & paneling',
...
//   },
//   {
//     name: 'Grand Elite Package',
//     price: '₹2,990/sft',
//     features: [
//       'Everything in Royal Heritage',
//       'Full home automation system',
//       'Private lift provision',
//       'Luxury sanitary ware — imported',
...
//   },
//   {
//     name: 'Supreme Signature Package',
//     price: '₹3,190/sft',
//     features: [
//       'Everything in Grand Elite',
...
const packages = [
  ...
  },
  {
    ...
    price: '₹3,590/sft',
    features: [
      'Everything in Luxury Villa',
      'Premium interiors',
      'Feature walls',
      'Motion sensors',
      'Smart lighting scenes',
      'Motorized curtain provision',
      "25 Years Structural Warranty",
      '3 Years Electrical & Plumbing Warranty',
    ],
    popular: true,
  },
  {
    ...
    price: '₹4,500/sft',
    features: [
      'Everything in Signature Villa',
      'Complete premium interiors',
      'Complete home automation',
      'Smart security integration',
      'Multi-room control',
      'Smart climate control',
      'Customized smart home ecosystem',
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                <Star size={12} style={{ color: '#F4B400' }} />
              ...
              >
                Live in a Villa That{' '}
                <span style={{ color: '#C0392B' }}>Defines You</span>
              </motion.h1>
              ...
              >
                Our luxury villa packages combine world-class architecture with premium materials and smart technology. Every villa is a masterpiece — crafted to stand the test of time and reflect your unique lifestyle.
              </motion.p>
              ...
              >
                Luxury Villas starting from ₹2,490/Sft
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          >
            ...
            <h2 className="font-black mb-3"
              ...
              Our <span style={{ color: '#C0392B' }}>Villa Packages</span>
            </h2>
        ...
        <div className="max-w-3xl mx-auto px-5 text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-sm mb-8"
              ...
              Contact us today for a free site visit and custom villa design consultation.
            </p>
