...
import { CheckCircle, ArrowRight, Phone, Hammer } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                <Hammer size={12} style={{ color: '#C0392B' }} />
                <span
              ...
              >
                Revamp your existing space or add new floors and extensions with
                minimal disruption to your daily life. We handle everything from
                demolition to final finishing — with zero compromise on quality.
              </motion.p>
              ...
              >
                Renovation starting from ₹500/Sft
              </motion.p>
            ...
            >
              <Image
                src="/services/Renovation%20%26%20Extensions.jpg"
                alt="Renovation"
                fill
      ...
      <section className="py-16" style={{ backgroundColor: '#ffffff' }}>
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          >
            ...
            >
              All Types of{' '}
              <span style={{ color: '#C0392B' }}>Renovation</span>
            </h2>
            <div
      ...
      >
        ...
        <div className="max-w-3xl mx-auto px-5 text-center relative z-10">
          ...
          >
            ...
            >
              Get a free site assessment and renovation quote today — no
              obligations.
            </p>
